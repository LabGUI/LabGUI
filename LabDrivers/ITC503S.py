...
# READ THE MANUAL for RS232 interfacing page 9 chapter 3.3 have to find a
# 25 to 9 pin connector, we only care about pins 1-3
...
#                    print("%s" % answer)
    ...
    def setControl(self, locked, remote):
        # same principles, its a binary number whos first bit is 0:local,
        # 1:remote, and second bit is 0:lock, 1:unlock
    ...
    def setHeaterAndGas(self, heater_auto, gas_auto):
        ...
        # the way it works is An, where n is a decimal number, whos first bit
        # (2^0) represents if heater is auto, and second bit represents if gas
        # flow is auto
