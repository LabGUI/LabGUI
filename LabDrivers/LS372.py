...
CHANNELS_IDX = {"PT2 Head": 1, "PT2 Plate": 2, "Still Plate RuOx": 3, "Cold Plate RuOx": 4,
                "MC Plate Cernox": 5, "PT1 Head": 6, "PT1 Plate": 7, "MC Plate RuOx": 8, "Magnet Cernox": 9}

param = {"PT2 Head": "K", "PT2 Plate": "K", "Still Plate RuOx": "K", "Cold Plate RuOx": "K",
                "MC Plate Cernox": "K", "PT1 Head": "K", "PT1 Plate": "K", "MC Plate RuOx": "K", "Magnet Cernox 1": "K","Magnet Cernox 2": "K"}

TEMP_CONTROL_PARAM = ['channel', 'filter', 'units',
                      'delay', 'current/power', 'htr limit', 'htr resistance']

HEATER_RANGE = ['Off', '31.6uA', '100uA', '316uA',
...
class Instrument(Tool.MeasInstr):
    ...
    def __init__(self, resource_name, debug=False, **kwargs):
        ...
        super(Instrument, self).__init__(resource_name, 'LS372', debug=debug,
