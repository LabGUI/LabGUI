...
#        self.instrument_drivers.append('JUSTATEST')
    ...
    def test_import_driver(self):
        ...
        for instr_name in self.instrument_drivers:
            ...
            if interface in [utils.INTF_SERIAL,utils.INTF_PROLOGIX,utils.INTF_VISA,utils.INTF_NONE]:
                ...
                print("%s doesn't seem to have correct interface (%s)..."%(instr_name, interface))
        ...
        for instr_name in self.instrument_drivers:
            ...
            for param in params:
                try:
                    ...
                    print("%s of %s doesn't seem to be measurable in debug mode..."%(param,instr_name))
